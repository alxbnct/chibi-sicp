# -*- mode: org; -*-
# Time-stamp: <2020-06-28 16:03:16 lockywolf>
...
The first time stamp also marks the beginning of the whole project.
...
"* DONE " at the beginning of each exercise name to indicate org-mode headlines.

#+begin_src elisp :exports code :wrap example :results output
  (save-excursion
    (org-babel-goto-named-src-block "study-sessions-data")
    (seq-map (lambda (x) 
	       (list
		 (list
