# -*- mode: org; -*-
# Time-stamp: <2020-05-22 13:33:25 lockywolf>
...
If I may, by the virtue of personally experiencing this transformative experience, give a few suggestions to the university curriculum designers, they would be the following:
 ...
 - Teach your student to use a timer when doing homework, even if it is not an org-mode timer. Realistic assessment of how much effort things actually take is a perspective-shifting experience.
...
*** Software
- GNU Emacs
- org-mode for Emacs ([[bib:Schulte:Davison:Dye:Dominik:2011:JSSOBK:v46i03]])
- chibi-scheme
...
- Revised Report on the Propagator Model ([[bib:radul2011propagator]])
